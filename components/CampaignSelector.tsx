    ...
    <div className="relative">
      ...
      >
        {isSwitching ? (
          ...
          <FolderOpen className="h-4 w-4 text-slate-800 dark:text-slate-300 shrink-0" style={{ color: 'rgb(var(--foreground-rgb))' }} />
        )}
        <span className="text-sm font-medium text-slate-800 dark:text-slate-300 truncate flex-1 text-left" style={{ color: 'rgb(var(--foreground-rgb))' }}>
            ...
            {activeCampaigns.length === 0 ? (
              ...
              activeCampaigns.map((camp: Campaign) => (
                ...
                >
                  ...
                  <span className="text-sm text-slate-800 dark:text-slate-300 truncate flex-1 text-left" style={{ color: 'rgb(var(--foreground-rgb))' }}>
                    {camp.campaign_name}
                  </span>
                  {camp.id === campaignId && (
